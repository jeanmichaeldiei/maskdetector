...
N95_IMAGE_PATH = os.path.join(IMAGE_DIR, 'N95-Face-Mask.png')
BLUE_IMAGE_PATH = os.path.join(IMAGE_DIR, 'blue-mask.png')
RED_IMAGE_PATH = os.path.join(IMAGE_DIR, 'redfacemask.png')
BLACK_IMAGE_PATH = os.path.join(IMAGE_DIR, 'blackfacemask.png')

MASK_PATHS = [DEFAULT_IMAGE_PATH,N95_IMAGE_PATH,BLUE_IMAGE_PATH,RED_IMAGE_PATH,BLACK_IMAGE_PATH]
def cli():
...
class FaceMasker:
    ...
    def mask(self):
        ...
        for face_landmark in face_landmarks:
            ...
            # mask face
            #found_face = True
            found_face = self._mask_face(face_landmark)
    ...
    def _save(self):
        dir_path = os.path.dirname(os.path.realpath(self.face_path))
        base=os.path.basename(self.face_path)
        name,ext = os.path.splitext(base)
        
        new_face_path = dir_path + "/masked/" +name +'-with-mask' + ext
